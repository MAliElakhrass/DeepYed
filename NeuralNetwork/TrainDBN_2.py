...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        np.savetxt("NeuralNetwork/Results/AutoEncoder/{}_Train_batch_res.csv".format(epoch), np.array(loss_train))
        np.savetxt("NeuralNetwork/Results/AutoEncoder/{}_Valid_batch_results.csv".format(epoch), np.array(loss_val))
        np.savetxt("NeuralNetwork/Results/AutoEncoder/{}_Valid_Res_per_epoch.csv".format(epoch), np.array(valid_epoch))
        np.savetxt("NeuralNetwork/Results/AutoEncoder/{}_Train_Res_per_epoch.csv".format(epoch), np.array(train_epoch))
        np.savetxt("NeuralNetwork/Results/AutoEncoder/{}_Differences.csv".format(epoch), np.array(all_differences))
